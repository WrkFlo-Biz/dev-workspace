...
LOG_ROTATE_CRON_LOG_PATH="${DWS_LOG_ROTATE_CRON_LOG_PATH:-/tmp/dws-log-rotate.cron.log}"
SESSION_CLEANUP_CRON_LOG_PATH="${DWS_SESSION_CLEANUP_CRON_LOG_PATH:-/tmp/dws-session-cleanup.cron.log}"
