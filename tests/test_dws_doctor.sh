...
make_fixture() {
  ...
  export DWS_LOG_ROTATE_CRON_LOG_PATH="${RUNTIME_ROOT}/dws-log-rotate.cron.log"
  export DWS_SESSION_CLEANUP_CRON_LOG_PATH="${RUNTIME_ROOT}/dws-session-cleanup.cron.log"
